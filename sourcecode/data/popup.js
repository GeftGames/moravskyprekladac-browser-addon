...
function ApplySettings(){
    if (currentPageRule==undefined){
        console.log("defaultRule", defaultRule);
        console.log("currentPageRule", currentPageRule);
        document.getElementById("settingPageRule").checked=defaultRule;
    }else{
    ...
    chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
        ...
        if (request.receiver == "popup") {
            ...
            if (request.command === "pagerule") {
                ...
                currentUrl=data.url;
                if (currentPageRule==undefined) document.getElementById("settingPageRule").checked=defaultRule;
                else document.getElementById("settingPageRule").checked=currentPageRule;
            }
        }
    });
}
...
function SetLangTexts() {
    ...
    document.getElementById("textDefaultRule").innerText=langsInFile.AutoTranslate;
    ...
    document.getElementById("textDelautlRuleMoreInfo").innerText=langsInFile.DelautlRuleMoreInfo;
    document.getElementById("textOnlyCzech").innerText=langsInFile.OnlyCzech;
}